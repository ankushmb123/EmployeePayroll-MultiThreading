  ...
  namespace EmployeePayrollTest
{
    ...
    public class UnitTest1
    {
        ...
        public void GivenEmployeeList_InAddingEmployeeMethod_ReturnSameListThatisAdded()
        {
            ...
            employeesListToBeAddedToDB.Add(new EmployeeDetails { employeeName = "Ankush", gender = "M", phoneNo = 7906552015, employeeAddress = "Agra, U.P", startDate = DateTime.Now, basicPay = 1800000, deductions = 250000, incomeTax = 150000, companySelect = 1, employeeSelect = 18, departmentSelect = 2, });
            employeesListToBeAddedToDB.Add(new EmployeeDetails { employeeName = "Ganesh", gender = "M", phoneNo = 9991661664, employeeAddress = "VPO Radaur, Rajasthan", startDate = DateTime.Now, basicPay = 1200000, deductions = 200000, incomeTax = 100000, companySelect = 3, employeeSelect = 19, departmentSelect = 4, });
